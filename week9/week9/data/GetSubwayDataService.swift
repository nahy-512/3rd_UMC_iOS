...
struct GetPersonDataService {
    ...
    func getSubwayInfo(completion : @escaping (NetworkResult<Any>) -> Void) {
    ...
    private func isValidData(data: Data) -> NetworkResult<Any> {
        ...
        // 성공적으로 decode를 마치면 success에다가 response 부분을 담아서 completion을 호출
        return .success(decodedData.response)
    }
}
